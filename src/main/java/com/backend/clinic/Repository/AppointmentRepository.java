...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
        ...
        boolean existsByDoctor_DoctorIdAndPatient_PatientIdAndStatusNotIn(Long doctorId, Long patientId,
                        java.util.List<String> statuses);

        boolean existsByDoctor_DoctorIdAndPatient_PatientIdAndStatusIn(Long doctorId, Long patientId,
                        java.util.List<String> statuses);

        boolean existsByDoctor_DoctorIdAndPatient_PatientIdAndAppointmentDateAndAppointmentTimeAndStatusIn(
                        Long doctorId, Long patientId, java.time.LocalDate appointmentDate,
                        java.time.LocalTime appointmentTime, java.util.List<String> statuses);
