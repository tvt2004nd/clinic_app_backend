    ...
    public void run(String... args) throws Exception {
        ...
        if (!userRepository.existsByUsername(adminUsername)) {
            ...
            try {
                ...
                log.warn("Could not create admin user due to data integrity issue: {}. Skipping.", ex.getMessage());
            }
        } else {
        ...
        if (!userRepository.existsByUsername(doctorUsername)) {
            ...
            try {
                ...
                log.warn("Could not create doctor user due to data integrity issue: {}. Skipping.", ex.getMessage());
            }
        } else {
